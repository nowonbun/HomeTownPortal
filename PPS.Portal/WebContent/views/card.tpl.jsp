...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<div class="card-grid" >
				<a ng-repeat="card in cards" ng-href="{{card.href}}" class="card-item mdl-card fix128 mdl-shadow--2dp margin-5px {{card.typeHeaderClass}}" style="background: {{card.background}}">
